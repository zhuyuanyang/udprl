...
def main():
    ...
    logger.configure(dir = '../../exp/'+ str(args.env) + '/ppo_ordinal' + '-'+ str(args.bins)+ '-'+ str(args.seed)+ '-' +str(time_record))
    # logger.configure(dir = 'ppo_ordinal'+'-' + str(args.env) + str(args.bins)+ '-'+ time_record)

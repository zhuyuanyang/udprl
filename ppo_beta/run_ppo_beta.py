...
def main():
    ...
    parser.add_argument('--env', help='environment ID', default='Walker2dEnv-v1')
    ...
    logger.configure(dir = '../../exp/'+ str(args.env) + '/ppo_beta' + '-'+ str(args.seed)+ '-' +str(time_record))
    # logger.configure(dir = 'ppo_beta'+'-' + str(args.env) + '-'+ time_record)

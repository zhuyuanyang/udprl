...
class Model(object):
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
                 nsteps, ent_coef, vf_coef, max_grad_norm,tau):
        sess = tf.get_default_session()
        self.sess = sess

        act_model = policy(sess, ob_space, ac_space, nbatch_act, 1,tau, reuse=False)
        train_model = policy(sess, ob_space, ac_space, nbatch_train, nsteps,tau, reuse=True)
...
def learn(*, policy, env, nsteps, total_timesteps, ent_coef, lr, 
            ...
            log_interval=10, nminibatches=8, noptepochs=8, cliprange=0.2,
            save_interval=0, callback=None, tau):
